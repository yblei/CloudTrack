...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort cloud_track/
	$(ENV_PREFIX)black -l 79 cloud_track/
	$(ENV_PREFIX)black -l 79 tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 cloud_track/
	$(ENV_PREFIX)black -l 79 --check cloud_track/
	$(ENV_PREFIX)black -l 79 --check tests/
	$(ENV_PREFIX)mypy --ignore-missing-imports cloud_track/
